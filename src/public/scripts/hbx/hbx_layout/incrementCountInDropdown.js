/* global console, incrementCount, fetch, Headers,
updateCartDropDownPriceAndCount */
/* exported incrementCountInDropdown */

const incrementCountInDropdown = (element, num_ceiling) => {
  ...
  let item_quantity = incrementCount(element,num_ceiling);
